import { GangGenInfo, GangMemberInfo, GangOtherInfo, GangTaskStats, NS } from "Bitburner";
...
export async function main(ns: NS) {
    const [defTask] = ns.args as string[]
	const gang = ns.gang;
	...
	if (defTask && gang.getTaskNames().includes(defTask)) {
		defaultTask = defTask
	}
	// Main loop
	for (;;) {
